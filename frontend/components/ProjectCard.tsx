...
export default function ProductCard({ item }: { item: any }) {
	...
	return (
		<div
			key={item.id}
			className="md:w-[70%] w-[90%] relative hover:scale-[1.02] transition h-fit mx-auto my-4 rounded-lg"
		>
			{isLiked ? (
				<div
					className="p-2 absolute right-4 top-4 bg-white rounded-[50%] cursor-pointer"
					onClick={() => handleLike()}
				>
			...
			<div className="w-full rounded-b-lg border p-2">
				...
				<div className="flex justify-between flex-col px-4 py-2">
					...
					<p className="flex items-center mt-4 border border-transparent hover:border-gray-400 transition p-2">
						<img width={30} src="/assets/account.png" alt="" />
				...
				<div className="flex flex-col justify-between px-4 items-center">
					...
					<div className="flex flex-wrap my-2 w-full justify-center">
						<div className="border rounded-lg py-1 px-3 my-1 mx-2 min-w-[40px]">
				...
				<div className="flex flex-col px-4 justify-between items-center">
					<p className="text-sm font-semibold text-gray-500 my-1 font-sans">Link(s)</p>
